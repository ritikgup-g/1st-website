...
const menuData = [
  ...
  { name: "White Sauce Pasta", price: 199, img: "/download(1).jpg.jpeg" },
  ...
  { name: "Paneer Wrap", price: 179, img: "/download5.jpeg" },
  { name: "Veg Biryani", price: 219, img: "/download 7.jpg" },
  { name: "Veg Thali", price: 199, img: "/download4.jpg.jpeg" },
  ...
  return (
    <section id="menu" className="section section-light">
      ...
      <div className="menu-grid">
        {menuData.slice(0, visible).map((item) => (
